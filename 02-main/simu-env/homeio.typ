...
Home I/O (@fig-simu-env-homeio) is also made by Real Games. It simulates a House with a lot of domotic. This software has a cheap organization licence. Home I/O might also be interesting for ETE students. This software has a REST API for interfaced with all sensors and actuators. Like Factory I/O, it works quite well on Linux with wine.
