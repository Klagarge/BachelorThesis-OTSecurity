...
This thesis examines the security of embedded systems in a world where the distinctions between #gls("it", long: false) and #gls("ot", long: false) have increasingly blurred. Traditionally, #gls("ot", long: false) systems were physically isolated to ensure security. However, with the advent of the #gls("iot", long: false), these systems are becoming more interconnected, making them more susceptible to cyberattacks.

In response to these evolving challenges, #school.name overhauled his teaching laboratory dedicated to #gls("ot", long: false) security. This lab will focus on practical, hands-on exercises to help students to understand the unique challenges of securing embedded systems.
