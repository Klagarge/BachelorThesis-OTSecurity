...
#show: summary.with(
  ...
  //partner: partner,
  objective: [
    Produce attack scenarios where each includes a vulnerability, an attack using the vulnerability, and a solution to avoid the attack. These scenarios must be usable as the basis for a laboratory experience for students or industrial partners.
